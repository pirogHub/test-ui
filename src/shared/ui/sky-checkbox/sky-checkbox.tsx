...
export const SkyCheckbox = forwardRef<HTMLInputElement, CheckboxProps>(
	({checked = false, label, size = 'm', name, onBlur, onChange, ...rest}, ref) => {
...
SkyCheckbox.displayName = 'SkyCheckbox';
