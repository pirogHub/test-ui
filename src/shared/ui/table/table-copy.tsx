...
// 				break;
// 			case 'status':
// 				content = <StatusBadge status="analyze" />;
// 				break;
// 			case 'type':
// 				content = <div>{value}</div>;
// 				break;
...
// }: {
// 	CellContentCustomize?: <Data>(key: keyof Data, data: Data) => React.ReactNode;
// 	HeaderCellContentCustomise?: <Data>(key: keyof Data, data: Data) => React.ReactNode;
// }) => {
...
// 											return content ? (
// 												<TableCell
// 													sx={{border: '1px solid black', textOverflow: 'ellipsis'}}
// 													key={key}
// 												>
// 													{content}
// 												</TableCell>
